package com.haohao.betterportals.screen;

import com.haohao.betterportals.network.ChooseDestinationPayload;
...
public class PortalDestinationScreen extends Screen {
    ...
    public PortalDestinationScreen(OpenPortalScreenPayload payload) {
        super(Component.translatable("screen.betterportals.portal_destination"));
